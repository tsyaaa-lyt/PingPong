...
racket1 = Player('paddle.jpg', 30, 200, 4, 50, 150)
racket2 = Player('paddle.jpg', 520, 200, 4, 50, 150)
...
while game:
    ...
    if finish != True:
        ...
        #if ball reaches screen edges, change its movement direction
